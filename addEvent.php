...
if (isset($_POST['submit'])) {
    ...
    if (isset($error)) {
        ...
        $sql = "INSERT INTO events (event_name, event_detail, event_address, event_price, event_ppl_allow, event_date, event_image) VALUES ('$name', '$detail', '$venue', '$price','$max','$date','$img')";
        if ($conn->query($sql) === TRUE) {
            echo "<h3 style='color:red; text-align:center; margin-top:25px;'>" . "New event record created successfully" . "</h3>";
        } else {
