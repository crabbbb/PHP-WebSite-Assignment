...
if (isset($_POST['submit'])) {
    ...
    if (isset($error)) {
        ...
        $sql = "UPDATE announcement SET announcement_name = '$name', announcement_text = '$detail', announcement_category = '$category', announcement_image = '$img' WHERE announcement_id=$id";  
        if ($conn->query($sql) === TRUE) {
            echo "<h3 style='color:red; text-align:center; margin-top:25px;'>" . "Announcement updated successfully" . "</h3>";
        } else {
    ...
    <body>
        <div class="mainscreen">
            <div class="card">
                ...
                <div class="rightside">
                    <form method="post">
                        <h1 style="text-align:center;margin-bottom: 30px;margin-top: 20px;">Edit Announcement</h1>
                        ...
                        <input type="text" class="form-control" placeholder="Enter announncement category" name="category" autocomplete="off" required>
