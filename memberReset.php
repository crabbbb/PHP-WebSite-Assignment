...
if (isset($_POST['submit'])) {
    ...
    if (isset($error)) {
        ...
        $sql = "UPDATE member SET member_password = '$password' WHERE member_id='$id' ";
        if ($conn->query($sql) === TRUE) {
            echo "<h3 style='color:red; text-align:center; margin-top:65px;'>" . "Reset password successfully" . "</h3>";
        } else {
...
<body>
    ...
    <div class="container">
        ...
        <form id="Form1" method="post">
            ...
            <input type="text" placeholder="Member id" name="member" required>
            ...
            <div class="signup_link">
                Not a member? <a href="signinsignup.php">Signup</a>
            </div>
        </form>
